...
kable(get_count_tbl("gender"), caption="Gender")
kable(get_count_tbl("age"), caption="Age")
kable(get_count_tbl("race"), caption="Race")
kable(get_count_tbl("ethnicity"), caption="Ethnicity")
kable(get_count_tbl("education"), caption="Education")
kable(get_count_tbl("political_party"), caption="Political Party")
```
